...
public class MySQLCodeGenerator {
    private final static String PARENT_PACKAGE_NAME = "com.jsh.erp.datasource";
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/jsh_erp?useUnicode=true&useSSL=false&characterEncoding=utf8");
